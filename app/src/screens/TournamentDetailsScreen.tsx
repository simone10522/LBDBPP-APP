...
export default function TournamentDetailsScreen() {
  ...
  if (loading) {
    return <View style={styles.container}><Text style={styles.loadingText}>Caricamento...</Text></View>;
  }
  ...
  return (
    <ScrollView
      ...
      refreshControl={
        <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={darkPalette.text} />
      }
    >
      {error && (
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerStatus, {
          backgroundColor: tournament.status === 'completed' ? darkPalette.statusCompleted : tournament.status === 'in_progress' ? darkPalette.statusInProgress : darkPalette.statusDraft,
        }]}>
